...
export default function Predict() {
  ...
  // Include group stage always; include knockout matches only once both teams are known
  const phaseMatches = matches.filter(m => m.phase === phase && m.homeTeam && m.awayTeam)
